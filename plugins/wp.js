...
if (Config.WORKTYPE == 'private') {
    ...
    Ultroid.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Copyright © 2022 | Ultroid'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Ultroid.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
