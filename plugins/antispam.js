...
Ultroid.addCommand({ pattern: 'activate', fromMe: true, deleteCommand: false, desc: AS_DESC, }, (async (message, match) => {
...
Ultroid.addCommand({ pattern: 'off', fromMe: true, delownsewcmd: false, desc: AS_DESC, }, (async (message, match) => {
